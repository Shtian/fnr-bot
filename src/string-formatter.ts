...
const getEmojiBaby = () => ['👶', '👶🏻', '👶🏼', '👶🏽', '👶🏾', '👶🏿'][Math.floor(Math.random() * 7)];
const getEmojiGirl = () => ['👧', '👧🏻', '👧🏼', '👧🏽', '👧🏾', '👧🏿'][Math.floor(Math.random() * 7)];
const getEmojiBoy = () => ['👦', '👦🏻', '👦🏼', '👦🏽', '👦🏾', '👦🏿'][Math.floor(Math.random() * 7)];
const getEmojiWoman = () => ['👩', '👩🏻', '👩🏼', '👩🏽', '👩🏾', '👩🏿'][Math.floor(Math.random() * 7)];
const getEmojiMan = () => ['👨', '👨🏻', '👨🏼', '👨🏽', '👨🏾', '👨🏿'][Math.floor(Math.random() * 7)];
const getEmojiOldMan = () => ['👴', '👴🏻', '👴🏼', '👴🏽', '👴🏾', '👴🏿'][Math.floor(Math.random() * 7)];
const getEmojiOldWoman = () => ['👵', '👵🏻', '👵🏼', '👵🏽', '👵🏾', '👵🏿'][Math.floor(Math.random() * 7)];
